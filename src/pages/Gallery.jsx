...
const Gallery = () => {
  return (
    <div className="w-full h-full bg-gradient-to-r from-[#144c8b] to-[#8fe1c3]">
    <div className="  max-w-[1240px] mx-auto mt-0">
    <h1 className="text-6xl text-[#ffffff] font-bold tracking-tighter md:pt-8 text-center p-4 md:p-0"> Events Snapshots</h1>
