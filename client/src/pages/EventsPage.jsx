...
const EventsPage = () => {
  ...
  return (
    <div className="  max-w-[1240px] mx-auto mt-28 mb-10">
      <h1 className="md:text-6xl text-[2.5rem] text-[#144c8b] font-bold font-grotesk tracking-tighter  text-center">
        Our Events
      </h1>

      {/* ongoing events section */}
      <div className=" mx-6 ">
        <h3 className="md:text-4xl text-[2.5rem]  font-black font-grotesk tracking-tighter pt-8 text-left mb-6  bg-gradient-to-r from-blue-600  to-green-500  inline-block text-transparent bg-clip-text    ">
          Ongoing Events{" "}
        </h3>
      ...
      {/* past events section */}
      <div>
        <h3 className="md:text-4xl mt-2 text-[2.5rem] text-[#000000] font-bold font-grotesk tracking-tighter mx-6 pt-8 text-left">
          Past Events
        </h3>
      </div>
